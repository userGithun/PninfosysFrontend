...
function page() {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-6 md:px-16 lg:px-88 py-12">
        {/* Email Card */}
      ...
      {/* Contact Form */}
      <div className="w-full bg-gray-50 px-6 md:px-16 lg:px-88 py-12 flex flex-col md:flex-row gap-8 items-start justify-center">
        {/* Left Form Card */}
