...
export default function WorkshopModel({
    isOpen,
    closeModal,
    formData,
    handleChange,
    ...
    const { slug } = useParams(); // yaha se dynamic slug milega
    ...
    return (
        <div className="fixed inset-0 z-50 bg-gray-900/30 backdrop-blur-sm flex items-center justify-center px-4">
            <div className="bg-white w-full max-w-md rounded shadow-lg p-6 relative">
                ...
                <form
                    onSubmit={handleSubmit}// slug ke sath submit
                    className="space-y-4"
                >
                    ...
                    <div>
                        <label className="block text-gray-700 mb-1">Description (Heading)</label>
                        <input
                            type="text"
                            name="heading"
