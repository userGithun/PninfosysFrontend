...
import { Home, Layers, Cpu, Image, Calendar, BookOpen, Users, Briefcase, Mail, Settings, BookOpenCheck, Menu, X } from "lucide-react"
...
function Sidebar() {
  ...
  return (
    <>
      {/* Mobile Hamburger */}
      <div className="md:hidden flex justify-between items-center bg-sky-600 text-white p-4">
        <h2 className="text-lg font-bold tracking-wide">Pninfosys Panel</h2>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-sky-600 to-blue-800 text-white flex flex-col p-6 z-50 transform transition-transform duration-300
      ...
      >
        ...
        {/* Header */}
        <h2 className="text-2xl font-bold mb-8 tracking-wide hidden md:block">Pninfosys Panel</h2>
